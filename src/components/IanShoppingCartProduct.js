...
function IanShoppingCartProduct(props) {
  [v.sid, styles, v.name, v.startTime] = props
  console.log()
  //   return (
  //     <div key={v.sid} className={`${styles['shoppingcart-product']}`}>
  //       <div
  ...
  //               <p className={`${styles['product-title']}  mb-3`}>{v.name}</p>
  ...
  //           <p className={`mb-lg-2`}>{v.startTime}</p>
  //           <p className={`mb-lg-2`}>&emsp;&emsp;|</p>
  //           <p className={`mb-0`}>{v.endTime}</p>
  //         </div>
  ...
  //           <svg
  //             onClick={(e) => {
  //               setData(deletepruduct(data, v.sid))
  //             }}
  //             width="30"
  //             height="30"
  //             viewBox="0 0 30 30"

...
const LaiMobileDropdown = React.forwardRef((props, ref) => {
  const { displayPage, setDisplayPage, scrollPosition } = props

  const handleDisplayPage = (page) => {
    // setMobileDisplay(page)
    props.setDisplayPage(page)
  }
  return (
    <>
      <div
      ...
      >
        <div
          ...
          className={`${styles['mobile-member']} ${styles['mobile-wrap']}`}
        >
          <svg
        ...
        <div
          ...
          className={`${styles['mobile-coupon']} ${styles['mobile-wrap']}`}
        >
          <svg
            className={styles['mobile-icon']}
            width="24"
        ...
        <div
          ...
          className={`${styles['mobile-achievement']} ${styles['mobile-wrap']}`}
        >
          <svg
        ...
        <div
          ...
          className={`${styles['mobile-history']} ${styles['mobile-wrap']}`}
        >
          <svg
            className={styles['menu-icon']}
            width="24"
        ...
        <div
          ...
          className={`${styles['mobile-comment']} ${styles['mobile-wrap']}`}
        >
          <svg
            className={styles['menu-icon']}
            width="24"
        ...
        <div
          ...
          className={`${styles['mobile-favorite']} ${styles['mobile-wrap']}`}
        >
          <svg
            className={styles['menu-icon']}
            width="24"
...
export default LaiMobileDropdown

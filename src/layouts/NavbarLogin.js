...
import LoginNavstyles from './../styles/NavbarLogin.module.css'

export default function LoginNavBar() {
  return (
    <>
      <nav id={LoginNavstyles.loginNav}>
        <div className={LoginNavstyles.navbar}>
          <div className={LoginNavstyles.left}>
            <button className={LoginNavstyles.menu}>
              <svg
                width="25"
                height="36"
                viewBox="0 0 25 36"
            ...
            <button className={LoginNavstyles.logo}>
              <svg
                width="75"
                height="24"
                viewBox="0 0 75 24"
            ...
            <ul className={LoginNavstyles.nav_navigations}>
              <li>
                <a className={LoginNavstyles.link} href="/">
                  {' '}
                  商品總覽{' '}
                </a>
              </li>
          ...
          <div className={LoginNavstyles.right}>
            <ul className={LoginNavstyles.nav_icons}>
              <li>
                <svg
                  width="28"
                  height="28"
